...
ccm.files[ 'configs.js' ] = {
  ...
  "monitoring": { // log configuration for different component types -> has to complete
    ...
    "cloze": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "finish": { "parent": true, "user": true, "data": true }
      }
    },

    "comment": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
    ...
    "fast_poll": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
    ...
    "feedback": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "create": { "parent": true, "user": true, "data": true }
      }
    },

    "live_poll": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "finish": { "parent": true, "user": true, "data": true }
      }
    },

    "menu": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "click": { "parent": true, "user": true, "data": true }
      }
    },

    "pdf_viewer": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "start": { "parent": true, "user": true, "data": true },
    ...
    "quick_decide": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "click": { "parent": true, "user": true, "data": true },
        "finish": { "parent": true, "user": true, "data": true }
      }
    ...
    "quiz": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "finish": { "parent": true, "user": true, "data": true }
      }
    },

    "show_solutions": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
    ...
    "submit": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "submit": { "parent": true, "user": true, "data": true }
      }
    },

    "teambuild": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
    ...
    "upload": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
    ...
    "uml": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
        "sync": { "parent": true, "user": true, "data": true }
      }
    },

    "user": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
    ...
    "youtube": { "key": ["ccm.get", "https://mnutze.github.io/log-fork/resources/configs.js", "global"],
      "events": {
